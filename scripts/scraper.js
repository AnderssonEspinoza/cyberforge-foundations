...
async function main() {
  ...
  fs.writeFileSync(publicOutputPath, JSON.stringify(deduped, null, 2), "utf8");
  fs.writeFileSync(rootOutputPath, JSON.stringify(deduped, null, 2), "utf8");
  console.log(`[OK] ${deduped.length} noticias guardadas en ${publicOutputPath}`);
}
